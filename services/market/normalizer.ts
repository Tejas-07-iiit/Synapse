import { Candle, TickerInfo } from "@/types/market";

/**
 * Normalizer Engine for Binance Market Data
 * Standardizes API responses and WebSocket payloads into type-safe entities.
 */
