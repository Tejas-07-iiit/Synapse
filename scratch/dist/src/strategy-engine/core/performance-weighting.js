...
export class PerformanceWeightingEngine {
     ...
     */
    static getStrategyBoost(strategyId) {
     ...
     */
    static isQuarantined(strategyId) {
        const stats = this.strategyStatsMap.get(strategyId);
