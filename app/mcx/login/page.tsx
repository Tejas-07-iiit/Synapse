...
export default function McxLoginPage() {
  const router = useRouter();
  const { login, isAuthenticated, isLoading, error, setError, fetchMe } = useMcxAuthStore();
    ...
    <AuthLayout>
      ...
      >
        <div className="mb-10 text-center lg:text-left">
          <h2 className="text-3xl font-black text-foreground mb-2 tracking-tight uppercase">MCX Terminal</h2>
          <p className="text-muted-foreground font-medium">Enter your credentials to access commodity workspace</p>
        </div>
